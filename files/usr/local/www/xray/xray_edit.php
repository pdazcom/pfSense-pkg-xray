...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['act'])) {
    switch ($_POST['act']) {
        ...
        case 'import':
            ...
            $socksListen = trim($_POST['socks5_listen'] ?? '127.0.0.1');
            if (!filter_var($socksListen, FILTER_VALIDATE_IP, FILTER_FLAG_IPV4)) {
                $socksListen = '127.0.0.1';
            }

            $socksPort = (int)($_POST['socks5_port'] ?? 10808);
        ...
        case 'save':
            ...
            if (empty($input_errors)) {
                ...
                $instance = [
                    ...
                    'config_mode'         => in_array($_POST['config_mode'] ?? '', ['wizard', 'custom'], true)
                ...
                if (($instance['config_mode'] ?? 'wizard') !== 'custom' || $instance['custom_config'] !== '') {
                    xray_resync();
                }
...
// ── VLESS Import panel (before main form) ────────────────────────────────────
?>
